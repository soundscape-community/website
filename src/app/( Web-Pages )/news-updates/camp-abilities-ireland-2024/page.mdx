import CloseUpOfScreen from "@/static/images/camp-abilities/CloseUpOfScreen.jpg"
import PeopleWalkingAcrossAField from "@/static/images/camp-abilities/3PeopleWalkingAcrossAField.jpg"
...
- <Link className="text-orange text-sm underline" href="https://visionsports.ie/camp-abilities/">https://visionsports.ie/camp-abilities/</Link>
- <Link className="text-orange text-sm underline" href="https://kilfinaneoec.com/">https://kilfinaneoec.com/</Link>
- <Link className="text-orange text-sm underline" href="https://www.campabilities.org/">https://www.campabilities.org/</Link>
- <Link className="text-orange text-sm underline" href="https://soundscape.services/">https://soundscape.services/</Link>
