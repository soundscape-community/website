...
<div className="flex xl:flex-row flex-col gap-24 xl:items-start items-center">
    ...
    <Image className="h-auto md:w-[28rem] w-[18rem]  rounded-lg" src={first_img} height={0} width={0} alt="Image of a busy ice skating rink with a sign spelling out Amsterdamn in the background" />
</div>
